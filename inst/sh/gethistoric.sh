...
curl "https://wcc.sc.egov.usda.gov/nwcc/view?intervalType=$INTERVALTYPE+&report=$REPORT&timeseries=$SERIES&format=copy&sitenum=$STATION&year=$YEAR&month=$MONTH&day=$DAY"
#-o data/snoteldownloads/$STATION-$YEAR$MONTH$DAY.csv
